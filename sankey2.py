...
Description:
Helper functions for building Sankey diagrams using Plotly.
Takes relationships from a pandas DataFrame and turns them into
a network-style visualization that can be reused in dashboards
and data exploration apps.
"""
